      ...
      <main className={s.hero}>
        ...
        <div className={s.heroInner}>
          ...
          <div className={s.heroLeft}>
            ...
            <p className={s.tagline}>Smart, Fair &amp; Transparent SHS/TVET Placement</p>
            <button className="btn-primary" style={{ fontSize: 15, padding: '12px 32px' }} onClick={() => setShowModal(true)}>
              Check Placement
            </button>
          </div>
          ...
          <div className={s.trustCard}>
            {[
              ...
              <div key={item.title} className={s.trustItem}>
                <svg className={s.trustCheck} width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" aria-hidden="true">
